...
NEW_BASE_REPO ?= $(ECR_HOST)/gumroad/web_base
NEW_WEB_REPO ?= $(ECR_HOST)/gumroad/web
NEW_WEB_BASE_TEST_REPO ?= $(ECR_HOST)/gumroad/web_base_test
NGINX_REPO ?= $(ECR_HOST)/gumroad/web_nginx
NGINX_TAG ?= latest
BRANCH_APP_NGINX_REPO ?= $(ECR_HOST)/gumroad/branch_app_nginx
