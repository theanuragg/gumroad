...
class User < ApplicationRecord
  ...
  has_many :alive_collaborator_accounts, -> { alive }, foreign_key: :affiliate_user_id, class_name: Collaborator.name
  has_many :collaborating_products, through: :alive_collaborator_accounts, source: :products
