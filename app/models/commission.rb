  ...
  def create_completion_purchase!
    ...
    completion_purchase.ensure_completion do
      ...
      if completion_purchase.errors.present?
        begin
          completion_purchase.mark_failed!
        rescue StateMachines::InvalidTransition => e
          logger.error "Purchase for commission error: Could not create purchase for commission ID #{id} because #{e}"
        end
        raise "Failed to create completion purchase"
      else
