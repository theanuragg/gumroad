  ...
  private
    ...
    def create_watermark_pdf!(original_pdf_path:, watermark_text:)
      ...
      pdf.font_families.update(
        "ABC Favorit" => {
          normal: Rails.root.join("app", "assets", "fonts", "ABCFavorit", "ttf", "ABCFavorit-Regular.ttf"),
          italic: Rails.root.join("app", "assets", "fonts", "ABCFavorit", "ttf", "ABCFavorit-RegularItalic.ttf"),
          bold: Rails.root.join("app", "assets", "fonts", "ABCFavorit", "ttf", "ABCFavorit-Bold.ttf"),
          bold_italic: Rails.root.join("app", "assets", "fonts", "ABCFavorit", "ttf", "ABCFavorit-BoldItalic.ttf")
        }
      )
