...
export const startOauthRedirectChecker = ({
  ...
  const oauthRedirectChecker = setInterval(async () => {
    const stopOauthRedirectChecker = () => oauthRedirectChecker && clearInterval(oauthRedirectChecker);
