...
import { PayoutVerification, VerificationDetails } from "$app/components/server-components/PayoutPage/Verification";
...
type Props = {
  ...
  stripe_connect_embedded_notification_banner_enabled: boolean;
};
    ...
    >
      ...
      <form ref={formRef}>
        <section>
          ...
          {props.verification_details.show_verification_section ? (
            props.stripe_connect_embedded_notification_banner_enabled ? (
              <StripeConnectEmbeddedNotificationBanner />
            ) : (
              <PayoutVerification
                prompt_for_full_ssn={props.verification_details.prompt_for_full_ssn}
                prompt_for_photo_id={props.verification_details.prompt_for_photo_id}
                prompt_for_additional_id={props.verification_details.prompt_for_additional_id}
                prompt_for_company_id={props.verification_details.prompt_for_company_id}
                prompt_for_passport={props.verification_details.prompt_for_passport}
                prompt_for_visa={props.verification_details.prompt_for_visa}
                prompt_for_business_vat_number={props.verification_details.prompt_for_business_vat_number}
                prompt_for_power_of_attorney={props.verification_details.prompt_for_power_of_attorney}
                prompt_for_memorandum_of_association={props.verification_details.prompt_for_memorandum_of_association}
                prompt_for_proof_of_registration={props.verification_details.prompt_for_proof_of_registration}
                prompt_for_company_registration_verification={
                  props.verification_details.prompt_for_company_registration_verification
                }
                prompt_for_bank_statement={props.verification_details.prompt_for_bank_statement}
                prompt_for_enhanced_identity_verification={
                  props.verification_details.prompt_for_enhanced_identity_verification
                }
                verification_errors={props.verification_details.verification_errors}
                country={props.verification_details.country}
              />
            )
          ) : (
