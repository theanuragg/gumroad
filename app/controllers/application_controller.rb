  ...
  private
    ...
    def affiliate_from_cookies(product)
      ...
      if affiliate_user_ids.present?
        ...
        direct_affiliates_for_product_and_user = Affiliate.valid_for_product(product).direct.where(affiliate_user_id: affiliate_user_ids).order(Arel.sql("FIELD(affiliate_user_id, #{affiliate_user_id_string})"))
