  ...
  describe "#payments_props" do
    before do
      ...
      @base_props = {
        ...
        verification_details: {
          prompt_for_full_ssn: false,
          prompt_for_business_vat_number: false,
          prompt_for_photo_id: false,
          prompt_for_additional_id: false,
          prompt_for_company_id: false,
          prompt_for_passport: false,
          prompt_for_visa: false,
          prompt_for_power_of_attorney: false,
          prompt_for_memorandum_of_association: false,
          prompt_for_proof_of_registration: false,
          prompt_for_company_registration_verification: false,
          prompt_for_bank_statement: false,
          prompt_for_enhanced_identity_verification: false,
          show_verification_section: false,
          country: nil,
          verification_errors: {
            bank_account_statement: nil,
            business_vat_id_number: nil,
            individual_tax_id: nil,
            memorandum_of_association: nil,
            passport: nil,
            power_of_attorney: nil,
            stripe_additional_document_id: nil,
            stripe_company_document_id: nil,
            stripe_enhanced_identity_verification: nil,
        ...
        stripe_connect_embedded_notification_banner_enabled: false,
      }
    end

    context "when stripe_connect_embedded_notification_banner is enabled" do
      before do
        Feature.activate_user(:stripe_connect_embedded_notification_banner, seller)
      end

      it "sets stripe_connect_embedded_notification_banner_enabled to true" do
        expect(presenter.payments_props[:stripe_connect_embedded_notification_banner_enabled]).to be true
      end
    end
    ...
    context "when seller is from the US" do
      before do
        ...
        @verification_details = @base_props[:verification_details].merge({
      ...
      it "includes Stripe verification requests if applicable" do
        ...
        expect(presenter.payments_props).to eq(@base_us_props.merge!({
                                                                       ...
                                                                       verification_details: @base_us_props[:verification_details].merge({
                                                                                                                                           prompt_for_full_ssn: true,
                                                                                                                                           prompt_for_photo_id: true,
                                                                                                                                           prompt_for_company_id: true,
                                                                                                                                           ...
                                                                                                                                           verification_errors: {
                                                                                                                                             ...
                                                                                                                                             proof_of_registration: nil,
                                                                                                                                             company_registration_verification: nil,
                                                                                                                                             stripe_identity_document_id: "The identity information you entered cannot be verified. Please correct any errors or upload a document that matches the identity fields (e.g., name and date of birth) that you entered.",
                                                                                                                                             visa: nil
                                                                                                                                           }
                                                                                                                                         }),
                                                                     }))
