...
describe PaypalPayoutProcessor do
  ...
  describe "pay via paypal and handle IPNs" do
    before do
      ...
      @u3 = create(:singaporean_user_with_compliance_info, payment_address: "amir3_1351103838_biz@gumroad.com")
    ...
    it "creates the correct payment objects and update them once the IPN comes in" do
      ...
      expect(p3.payment_address).to eq @u3.payment_address
      ...
      described_class.handle_paypal_event("payment_date" => p1.created_at.strftime("%T+%b+%d,+%Y+%Z"),
                                          ...
                                          "unique_id_1" => p2.id,
                                          "mc_fee_1" => "3.99",
                                          "receiver_email_2" => p3.user.payment_address,
      ...
      described_class.handle_paypal_event("payment_date" => p3.created_at.strftime("%T+%b+%d,+%Y+%Z"),
                                          "receiver_email_0" => p3.user.payment_address,
