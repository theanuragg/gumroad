  ...
  describe "seller view" do
    ...
    context "viewing collaborators" do
      ...
      context "when there are some" do
        ...
        let!(:collaborator_four) { create(:collaborator, seller:, products: [product_four, product_five]) }

        it "displays a list of collaborators" do
          visit collaborators_path

          [
            { "Name" => collaborator_one.affiliate_user.username, "Products" => "2 products", "Cut" => "35% - 50%" },
            { "Name" => collaborator_two.affiliate_user.username, "Products" => "None", "Cut" => "30%" },
            { "Name" => collaborator_three.affiliate_user.username, "Products" => product_three.name, "Cut" => "30%" },
            { "Name" => collaborator_four.affiliate_user.username, "Products" => "2 products", "Cut" => "30%" },
          ].each do |row|
        ...
        it "displays details about a collaborator" do
          ...
          within_section collaborator_one.affiliate_user.name, section_element: :aside do
            ...
            expect(page).to have_link("Edit products")
          ...
          within_section collaborator_two.affiliate_user.name, section_element: :aside do
            ...
            expect(page).to have_link("Set products")
            expect(page).to have_button("Remove")
