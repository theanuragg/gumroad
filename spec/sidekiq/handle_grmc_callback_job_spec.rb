...
describe HandleGrmcCallbackJob do
  ...
  let(:transcoded_video) { create(:transcoded_video, job_id: "test_job_id", product_file: product_file, transcoded_video_key: "/attachments/68756f28973n28347/hls/", state: :processing) }
  ...
  describe "#perform" do
    context "when notification status is 'success'" do
      ...
      it "updates all processing transcoded videos, and marks them as completed" do
        ...
        product_file_2 = transcoded_video_2.reload.product_file.reload
